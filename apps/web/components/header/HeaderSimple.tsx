...
import { Box, Container, Group, Burger, Drawer, Stack, useMantineColorScheme, useMantineTheme } from '@mantine/core';
...
export function HeaderSimple() {
  ...
  const desktopNavItems = (
    <>
      ...
      {/* Speciály Dropdown */}
      <Menu trigger="hover" openDelay={40} closeDelay={140} shadow="lg" width={300}>
        <Menu.Target>
          <Link
            href="/specialy"
      ...
      >
        ...
        >
          ...
          <Group gap={16} wrap="nowrap" style={{ flexShrink: 0 }}>
            <SupportMenuButton compactOnMobile />
