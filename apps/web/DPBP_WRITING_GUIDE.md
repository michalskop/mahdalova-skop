...
**Výchozí styl je vysvětlující žurnalistika** (viz STYLE_GUIDE.md §2 v repozitáři data-pro-premierku): konkrétní záhada → důkazy → co to znamená (Fisher/Klein), tah a jasné sázky (Cadwalladr), lidský detail a čistá čeština (Třešňák/Němeček), věcná diagnóza systémových selhání zakončená směrem k řešení (Prokop).
