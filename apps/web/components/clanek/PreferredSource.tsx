...
/**
 * „Chci víc DataTimes.cz ve zprávách Googlu" – link to Google's
 * „preferované zdroje" setting for our domain. Rendered automatically in every
 * article byline (ArticleByline + date-only fallback in ArticleRenderer);
 * don't place it by hand. See packages/ui/DESIGN.md → `PreferredSource`.
 */
