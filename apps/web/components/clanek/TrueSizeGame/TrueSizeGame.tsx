...
export default function TrueSizeGame() {
  ...
  useEffect(() => {
    const scale = projectionId === "peters" ? (portraitMobile ? 0.76 : 0.80) : projectionId === "mercator" ? (portraitMobile ? 0.78 : 0.9) : projectionId === "mollweide" ? (portraitMobile ? 0.62 : 0.66) : ["robinson", "winkel"].includes(projectionId) ? (portraitMobile ? 0.64 : 0.68) : (portraitMobile ? 0.68 : 0.72);
          ...
          >
            ...
            >
              <button
                ...
                title="Nová hra"
              >
                <svg viewBox="0 0 24 24" width="27" height="27" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 11a8 8 0 1 0 1.2 5.4" /><path d="M20 5v6h-6" /></svg>
              </button>
              {roundMenuOpen && (
                <div
