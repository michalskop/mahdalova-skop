...
export default function TrueSizeGame() {
  ...
  useEffect(() => {
    const scale = projectionId === "peters" ? (portraitMobile ? 0.76 : 0.80) : projectionId === "mercator" ? (portraitMobile ? 0.78 : 0.9) : projectionId === "mollweide" ? (portraitMobile ? 0.62 : 0.66) : (portraitMobile ? 0.68 : 0.72);
