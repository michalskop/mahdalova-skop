  ...
  return (
    <Container size="lg" bg="background.1" maw="1200px" w="100%" p={0} m="0 auto">
      ...
      <Box component="section" px={{ base: 16, md: 24 }} pb={{ base: 28, md: 42 }}>
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="md">
          ...
          <Paper p={{ base: 'lg', md: 'xl' }} radius={8} withBorder bg="brandRoyalBlue.8" c="background.0">
            ...
            <Title order={2} size="1.25rem" >250 milionů rozpočtu, 650 milionů útraty</Title>
      ...
      <Box component="section" px={{ base: 16, md: 24 }} py={{ base: 20, md: 36 }}>
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl">
          <Stack>
            <Title order={2} size="1.25rem" >Co tím zjišťujeme</Title>
            <Text size="lg">
          ...
          <Paper p="lg" radius={8} withBorder>
            <Title order={3} size="1.05rem" mb="sm" >Metodická hranice</Title>
            <Text>
      ...
      <Box id="analyzy" component="section" px={{ base: 16, md: 24 }} py={{ base: 28, md: 42 }}>
        <Group justify="space-between" align="end" mb="lg">
          <Title order={2} size="1.25rem" >Analýzy</Title>
            ...
            >
              <Stack h="100%" justify="space-between">
                <Stack gap="xs">
                  ...
                  <Title order={3} size="1.05rem" style={{ lineHeight: 1.18 }}>{branch.title}</Title>
      ...
      <Box component="section" px={{ base: 16, md: 24 }} py={{ base: 28, md: 42 }} bg="background.2">
        <Title order={2} size="1.25rem" mb="md" >Zdroje a interpretační vrstva</Title>
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl">
          <Stack>
