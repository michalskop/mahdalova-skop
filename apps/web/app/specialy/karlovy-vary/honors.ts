...
export type HonorRecipient = {
  ...
  source: string;
  status?: 'announced';
  // Jak konkrétní ocenění zdůvodnil sám festival (parafráze anglického textu
  // z archivu KVIFF, sekce "Awarded Guests" daného ročníku) – u ročníků, kde
  // archiv od cca 2015 uvádí jen holý název ceny bez odůvodnění, a u jmen
  // doplněných přes Wikipedii (KVIFF text nemáme), pole zůstává prázdné.
  citationCz?: string;
};
