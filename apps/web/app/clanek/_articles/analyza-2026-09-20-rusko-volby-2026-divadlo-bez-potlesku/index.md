...
V neposlední řadě se zářijové hlasování proměnilo v zatěžkávací zkoušku pro samotnou byrokratickou vertikálu. Pro Kreml představovaly volby ideální prověrku toho, jak spolehlivě fungují regionální gubernátoři a jejich aparáty. Vedení státu si potřebovalo ověřit, zda místní elity dokážou i pod tlakem sankcí, výpadků zásobování a skryté společenské únavy dodat do Moskvy přesně nařízená čísla, aniž by tím v regionech vyvolaly viditelné nepokoje.

## Jak se vyrábí kýžených 50 procent

Aby se Kreml vyhnul scénáři z roku 2011, kdy propad podpory vyústil v masové protesty na Bolotném náměstí, funguje letošní model na bázi přísných kvót a selekce. Úřady nejprve nemilosrdně utnuly poslední legální ventil reálného nesouhlasu, kterým byla tradiční liberální strana [Jabloko](https://eng.yabloko.ru). Přestože byla léta marginální silou na okraji zájmu, její otevřený požadavek na okamžité příměří na Ukrajině začal během léta 2026 nečekaně silně rezonovat mezi vyčerpanou společností. V srpnu proto zasáhl Nejvyšší soud Ruské federace a stranu z volebního klání definitivně vyškrtl, což vyvolalo protesty jejích příznivců přímo před budovou soudu, [jak informovala agentura AFP](https://tvpworld.com/94789190/yabloko-russias-only-anti-war-party-banned-from-duma-elections). Záměr byl průhledný: na hlasovacím lístku nesměla zůstat ani jediná alternativa k pokračování bojů.

Samotný volební výsledek pak v moderním Rusku není předmětem odhadů ani sociologických průzkumů, ale centrálních směrnic. Úředníci prezidentské kanceláře rozeslali během září do regionů přesné koridory, v nichž se mají konečná čísla pohybovat. Celostátní zisk Jednotného Ruska musí bezpodmínečně překročit 50 procent a napříč federálními subjekty má striktně oscilovat v mantinelech mezi 47 a 53 procenty. Zvláštní režim pak Moskva nařídila pro okupovaná území Doněcké, Luhanské, Záporožské a Chersonské oblasti. Zde úřady stanovily minimální hranici pro volební účast i zisk vládní strany shodně na 70 procent, přičemž okupační správa v Doněcku ohlásila přes milion „předčasně odvolených“ obyvatel už během prvních hodin.

Tam, kde dříve režimu stačilo svážet zaměstnance k urnám podnikovými autobusy, navíc plně převzala otěže digitalizace. Distanční elektronické hlasování se stalo neprůhlednou černou skříňkou, která je letos nasazena ve 33 regionech a pokrývá přes 48 milionů oprávněných voličů. [Nezávislý server Meduza](https://meduza.io/en/feature/2026/09/18/russia-s-state-duma-elections-begin-with-record-online-turnout-a-million-votes-in-occupied-donetsk-and-attempts-to-bribe-observers) zmapoval do očí bijící anomálie hned od prvních minut hlasování – v Moskevské oblasti systém zaznamenal první odevzdaný online hlas pouhých 38 sekund po pátečním spuštění.
...
Následující přehled shrnuje, jak se zářijové hlasování liší od posledních voleb do Státní dumy v roce 2021 – od předepsaných výsledků přes rozšíření elektronického hlasování až po rostoucí rozpočet celé operace.

| Parametr | Zářijové volby 2026 | Volby 2021 (výchozí stav) | Změna a kontext |
|---|---|---|---|
| Počet volených křesel | 450 (225 poměrně + 225 většinově) | 450 (smíšený systém) | Volební inženýrství obvodů zůstává zachováno |
| Vládní Jednotné Rusko | Předepsaný cíl: 47–53 % (okupovaná území 70 %+) | Zisk: 49,8 % hlasů / 324 křesel (72 %) | Cílem Kremlu je udržet ústavní většinu 300+ křesel |
| Protiválečná opozice | 0 kandidátů (Jabloko vyřazeno soudem) | Účast Jabloka povolena (zisk 1,34 %) | Jakákoliv debata o příměří byla kriminalizována |
| Elektronické hlasování (DEG) | 33 regionů (přes 48 mil. oprávněných voličů) | Pouze 7 regionů | Expanze netransparentního digitálního nástroje |
| Rozpočet voleb (ÚVK) | 23,3 miliardy rublů | 21,4 miliardy rublů | Nákladný administrativní rituál uprostřed krize |
| Délka hlasování | 3 dny (18.–20. září 2026) | 3 dny (zavedeno v době pandemie covidu) | Vícedenní okno znemožňuje noční kontrolu uren |

## Divadlo na účet společnosti

Hlasování v září 2026 není zápasem o moc. Složení 450členné Dumy zůstane rozděleno mezi Jednotné Rusko a čtyři loajální parlamentní satelity – komunisty, nacionalisty z LDPR, Spravedlivé Rusko a Nové lidi –, které v klíčových momentech hlasují s Kremlem.

Přesto se za hladkým průběhem skrývá křehkost. Režim, který musí vyřadit marginální protiválečnou stranu, nutit učitele k hlášení účasti rodičů a nařizovat přesné rozmezí výsledků centrálním dekretem, nevěří vlastnímu obyvatelstvu.

Volební lístek vhozený do urny nebo odeslaný přes státní portál Gosuslugi už dávno není vyjádřením politické preference. Je to úřední stvrzenka, že občan přijal pravidla hry a je ochoten podepsat svou poslušnost systému, který jej posílá do zákopů.
