...
*Umístění: `docs/redakcni-styl/REDAKCNI_MANUAL.md`. Tohle je kanonická
strojově i lidsky čitelná verze; čtenářský booklet (.docx) se z ní odvozuje.*
...
**Rytmus vychází z myšlenky, ne z efektní šablony.** Nevršíme kousavé holé věty a jednoslovná oznámení ve vzorci „očekávání → krátké údery → závěrečná pointa“ (*Žádný plán. Žádná analýza. Jen číslo.*). Takový rytmus působí mechanicky, zvlášť když se opakuje napříč texty. Související fakt, výhradu a důsledek raději spojíme do přirozeného souvětí nebo plynulého odstavce. Krátká věta má smysl jen tam, kde odpovídá skutečnému tempu vyprávění a nese samostatnou informaci, ne jako automatický prostředek důrazu.
...
- Zdroj uvádíme na místě, kde z něj čerpáme: popisným odkazem v příslušné větě, u citace nebo přímo u grafu. Souhrnné odstavce „Zdroje:“ na konci článku nepoužíváme; oddělují důkaz od tvrzení a čtenáři neříkají, který pramen dokládá kterou pasáž. Rozsáhlejší výpočet či aparát patří do samostatné metodiky. Neodkazujeme přes dočasnou adresu chatu, existuje-li veřejný zdroj.
...
- Technický manuál speciálů — `../specialy/TECHNICKY_MANUAL.md`
- Data pro budoucí premiérku — `../specialy/data-pro-budouci-premierku/PSANI.md`
- Karlovy Vary v datech (KVIFF) — `../specialy/kviff/PSANI.md`
...
**Vizuální systém:** `../design/DESIGN.md`.
