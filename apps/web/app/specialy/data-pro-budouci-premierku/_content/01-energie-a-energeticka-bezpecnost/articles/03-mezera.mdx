...
---
## 1. Jádro jako „budoucí uklidňovadlo“
Politický diskurz v ČR se upíná k jednomu datu: 2036. Rok, kdy má být spuštěn první nový blok v Dukovanech. Tento slib funguje jako psychologické uklidňovadlo. Pocit, že „jádro všechno vyřeší“, nám dovoluje odkládat nepříjemná rozhodnutí o dnešní síti a flexibilitě.

Budoucí premiérka by však měla mít na paměti jedno číslo: **14 let**. To je průměrné zpoždění, se kterým se v posledních dvou dekádách v Evropě otevíraly moderní jaderné reaktory (Olkiluoto ve Finsku, Flamanville ve Francii). 
...
## 2. Vakuum 2033 a dva světy jedné soustavy
...
## 3. Spící obr: Teplárenství jako obří baterie
...
## 4. Hardware suverenita: Fyzika drátů
