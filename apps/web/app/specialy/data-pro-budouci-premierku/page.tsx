...
const G10 = <>
  <g fill="rgba(255,255,255,0.25)">
    ...
    <circle cx={40} cy={55} r={4.5}/><circle cx={160} cy={55} r={4.5}/>
    <circle cx={40} cy={70} r={4.5}/><circle cx={160} cy={70} r={4.5}/>
    <circle cx={40} cy={85} r={4.5}/><circle cx={160} cy={85} r={4.5}/>
    <circle cx={40} cy={100} r={4.5}/><circle cx={160} cy={100} r={4.5}/>
  ...
  <g fill="rgba(255,255,255,0.5)">
    <circle cx={25} cy={130} r={4.5}/><circle cx={40} cy={130} r={4.5}/><circle cx={55} cy={130} r={4.5}/><circle cx={70} cy={130} r={4.5}/><circle cx={85} cy={130} r={4.5}/><circle cx={100} cy={130} r={4.5}/><circle cx={115} cy={130} r={4.5}/><circle cx={130} cy={130} r={4.5}/><circle cx={145} cy={130} r={4.5}/><circle cx={160} cy={130} r={4.5}/><circle cx={175} cy={130} r={4.5}/>
    <circle cx={40} cy={145} r={4.5}/><circle cx={55} cy={145} r={4.5}/><circle cx={70} cy={145} r={4.5}/><circle cx={85} cy={145} r={4.5}/><circle cx={100} cy={145} r={4.5}/><circle cx={115} cy={145} r={4.5}/><circle cx={130} cy={145} r={4.5}/><circle cx={145} cy={145} r={4.5}/><circle cx={160} cy={145} r={4.5}/>
  </g>
...
const G_FINANCE = <>
  <g fill="#4d5469">
    ...
    <circle cx={60} cy={60} r={4.5}/><circle cx={80} cy={60} r={4.5}/>
    <circle cx={40} cy={80} r={4.5}/><circle cx={60} cy={80} r={4.5}/><circle cx={80} cy={80} r={4.5}/>
    <circle cx={40} cy={100} r={4.5}/><circle cx={60} cy={100} r={4.5}/><circle cx={80} cy={100} r={4.5}/>
    <circle cx={40} cy={120} r={4.5}/><circle cx={60} cy={120} r={4.5}/><circle cx={80} cy={120} r={4.5}/><circle cx={100} cy={120} r={4.5}/><circle cx={120} cy={120} r={4.5}/><circle cx={140} cy={120} r={4.5}/><circle cx={160} cy={120} r={4.5}/>
    <circle cx={60} cy={140} r={4.5}/><circle cx={80} cy={140} r={4.5}/><circle cx={100} cy={140} r={4.5}/><circle cx={120} cy={140} r={4.5}/><circle cx={140} cy={140} r={4.5}/>
    <circle cx={80} cy={160} r={4.5}/><circle cx={100} cy={160} r={4.5}/><circle cx={120} cy={160} r={4.5}/>
  </g>
  <g fill="#efb704">
    <circle cx={100} cy={80} r={4.5}/><circle cx={120} cy={80} r={4.5}/>
    <circle cx={100} cy={100} r={4.5}/><circle cx={120} cy={100} r={4.5}/><circle cx={140} cy={100} r={4.5}/><circle cx={160} cy={100} r={4.5}/>
  </g>
  <g fill="#ef6925">
    <circle cx={100} cy={60} r={4.5}/><circle cx={120} cy={60} r={4.5}/>
    <circle cx={140} cy={80} r={4.5}/>
  </g>
  <g fill="#de1743">
    <circle cx={100} cy={40} r={4.5}/><circle cx={120} cy={40} r={4.5}/>
...
const CHAPTERS = [
  ...
  {n:'04',title:'Regionální propasti',href:'/specialy/data-pro-budouci-premierku/04-regionalni-propasti',available:true,dots:D09,accent:'#1a9fbd',customSvg:G_REGIONS},
  {n:'05',title:'Úroveň vzdělávání',href:'/specialy/data-pro-budouci-premierku/05-uroven-vzdelavani',available:true,dots:D02,accent:'#639e0a',customSvg:G02},
  {n:'06',title:'Ekonomická nerovnost',href:'/specialy/data-pro-budouci-premierku/06-ekonomicka-nerovnost',available:true,dots:D09,accent:'#efb704',customSvg:G09},
  // BLOK 3: Technologie a ekonomika budoucnosti
  {n:'07',title:'AI a trh práce',href:'/specialy/data-pro-budouci-premierku/07-ai-a-trh-prace',available:true,dots:D06,accent:'#4c4f8e',customSvg:G06},
  ...
  {n:'09',title:'Energie a energetická bezpečnost',href:'/specialy/data-pro-budouci-premierku/09-energie-a-energeticka-bezpecnost',available:true,dots:D01,accent:'#f76800',customSvg:G01},
  // BLOK 4: Fyzický svět a vnější hrozby
  {n:'10',title:'Klimatická změna',href:'/specialy/data-pro-budouci-premierku/10-klimaticka-zmena',available:true,dots:D04,accent:'#f01745',customSvg:G04},
  {n:'11',title:'Bezpečnost a konflikty',href:'/specialy/data-pro-budouci-premierku/11-bezpecnost-a-konflikty',available:true,dots:D05,accent:'#a03250',customSvg:G08},
  {n:'12',title:'Informační manipulace',href:'/specialy/data-pro-budouci-premierku/12-informacni-manipulace',available:true,dots:D12,accent:'#8b6240',customSvg:G12},
  // BLOK 5: Systém, stát a peníze
  {n:'13',title:'Oligarchizace a korupce',href:'/specialy/data-pro-budouci-premierku/13-oligarchizace-a-korupce',available:true,dots:D07,accent:'#6e227d',customSvg:G07},
  {n:'14',title:'Veřejné finance a daně',href:'/specialy/data-pro-budouci-premierku/14-verejne-finance-a-dane',available:true,dots:D06,accent:'#a47d03',customSvg:G_FINANCE},
  {n:'15',title:'Efektivní vládnutí',href:'/specialy/data-pro-budouci-premierku/15-efektivni-vladnuti',available:true,dots:D08,accent:'#0e926a',customSvg:G_VLADNUTI},
];
  ...
  const inner = (
    <div
      ...
      style={{
        ...
        ['--ch-accent-rgb' as string]: hexToRgbString(chapter.accent),
        background: DARK,
        borderRadius: 14,
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .ch-active:hover {
          ...
          box-shadow:
            ...
            0 0 28px rgba(var(--ch-accent-rgb), 0.18) !important;
        }
        .ch-card-number {
          margin-bottom: 10px;
          opacity: 0.85;
