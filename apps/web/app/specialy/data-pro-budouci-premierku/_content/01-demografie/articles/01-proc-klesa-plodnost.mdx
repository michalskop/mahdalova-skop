...
<style>{`
.dt-visual { background: #f8f6f0; border: 1px solid #e8e3d2; border-radius: 6px; padding: 18px 20px 16px; margin: 28px 0; }
.dt-visual-kicker { font-family: var(--font-roboto-condensed), Arial, sans-serif; font-size: 10px; letter-spacing: 0.12em; text-transform: uppercase; font-weight: 700; color: #8b0e2b; margin: 0 0 8px; }
.dt-visual-title { font-family: var(--font-roboto-condensed), Arial, sans-serif; font-size: 20px; font-weight: 700; line-height: 1.25; margin: 0 0 8px; color: #1a1a1a; }
.dt-visual-note { font-family: var(--font-roboto-condensed), Arial, sans-serif; font-size: 14px; color: #333333; line-height: 1.5; margin: 0 0 14px; }
...
<div className="dt-visual">
  ...
  <svg className="dt-visual-svg" viewBox="0 0 860 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Úhrnná plodnost v Česku od roku 1990 do roku 2025 v pětiletých intervalech, hranice prosté reprodukce 2,10 dítěte na ženu">
    ...
    <text x="72" y="282" fontSize="11" fill="#333333">Zdroj: ČSÚ, časové řady úhrnné plodnosti (csu.gov.cz/produkty/oby_cr); rok 2025 odhad z kulatého stolu PSP 27. 4. 2026</text>
  </svg>
</div>
