...
Use **http://localhost:3001/clanek/skutecna-velikost**. Stop an existing development server before restarting or building in the same checkout. No other port is needed.
